...
export default function BookingSection({ defaultPackage }: { defaultPackage?: string }) {
  ...
  return (
    ...
    >
      {/* Background image */}
      <Image
        src={withBasePath("/assets/booking-bg.jpg")}
        alt=""
        fill
      ...
      <div ref={ref} className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <form onSubmit={handleSubmit} noValidate>
            ...
            <button
              type="submit"
              className="mt-6 w-full py-4 rounded-[5px] font-sans text-[0.95rem] font-bold text-dark bg-gold
                         flex items-center justify-center gap-2.5
                         hover:bg-[#a07342] transition-colors duration-200
                         shadow-[0_4px_18px_rgba(187,137,84,0.20)]"
            >
